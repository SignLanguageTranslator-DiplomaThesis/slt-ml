...
from model.sign_classifier.classifier import SignLanguagePredictor
...
def main():
    ...
    sign_gesture_classifier = SignLanguagePredictor()
    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks, results.multi_handedness):
                ...
                sign_gesture_index = sign_gesture_classifier.predict(coordinate_converter.normalized_landmarks)
